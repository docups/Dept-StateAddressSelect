     ...
     var directive = {
      ...
      function template() {
           return [
                ...
                '</style>',
                '<div> ',
                '<select id="selectShip" name="shipDepartments" ng-model="shipDepartmentSelect" [(value)]="shipDepartmentSelected"> ',
                ...
                '</div>',
                '<div>',
                '<select id="selectShip" name="shipStates" ng-model="shipStateSelect" [(value)]="shipStateSelected")',              
                ...
                '<input id="addressSearch" class="form-control" type="text" ng-model="ShipAddress" ng-readonly="readonlyshipping" required ng-change="searchShipAddresses(ShipAddress)" typeahead-min-length="1" typeahead="address as (address.AddressName + \' \' + (address.FirstName || \'\') + \' \' + (address.LastName || \'\') + \' \' + (address.Street1 || \'\') + \' \' + (address.Street2 || \'\') + \' \' + (address.City || \'\') + \' \' + (address.State || \'\') + \' \' + (address.Zip || \'\')) for address in shipaddresses | filter:$viewValue | limitTo:50" />',
...
function largebilladdresssearch() {
    ...
    function template() {
  		  return [
  				 ...
  				 '</style>',
  				 '<div> ',
  				 '<select id="selectBill" name="billDepartments" ng-model="billDepartmentSelect" [(value)]="billDepartmentSelected"> ',
  				 ...
  				 '</div> ',
  				 '<div> ',
  				 '<select id="selectBill" name="billStates" ng-model="billStateSelect" [(value)]="billStateSelected"> ',
